...
namespace Plugin.Games
{
    ...
    public interface IGames
    {
        ...
        /// </summary>
        /// <param name="achievementid">The id number for the achievement.</param>
        /// <param name="amount">
        ...
        /// The Boolean in a successful response indicates whether the achievement 
        /// is now unlocked.
        /// </returns>
        Task<bool> IncrementAchievementAsync(string achievementid, int amount);
        ...
        Task<IReadOnlyList<GamesAchievement>> GetAchievementsAsync();
        ...
        /// </returns>
        Task<bool> SetAchievementProgressAsync(string achievementid, int amount);
        ...
        /// <returns>A Task that completes when the leaderboard is displayed.</returns>
        Task ShowLeaderBoardsAsync(string leaderBoardId);
#if ANDROID
        /// <summary>
        ...
        /// <returns>A Task that completes when the leaderboard is displayed.</returns>
        Task ShowLeaderBoardsAsync(string leaderBoardId, GamesLeaderBoardTimeSpan timeSpan, GamesLeaderboardCollection collection);
        ...
        /// <param name="timeSpan"> to retrieve data for. Valid values are <see cref="GamesLeaderBoardTimeSpan.Daily"/>, <see cref="GamesLeaderBoardTimeSpan.AllTime"/>, and <see cref="GamesLeaderBoardTimeSpan.Weekly"/></param>
        /// <returns>A Task that completes when the leaderboard is displayed.</returns>
        Task ShowLeaderBoardsAsync(string leaderBoardId, GamesLeaderBoardTimeSpan timeSpan);
#endif
        /// <summary>
        ...
        Task<IReadOnlyList<GamesLeaderboard>> GetLeaderBoardDataAsync();
        ...
        Task<GamesLeaderboard> GetLeaderBoardDataAsync(string leaderBoardId);
#if ANDROID
        /// <summary>
        ...
        /// </param>
        /// <returns>A Task that returns a <see cref="IReadOnlyList{T}"/> of <see cref="GamesLeaderboardScore"/></returns>
        Task<IReadOnlyList<GamesLeaderboardScore>> GetPlayerCenteredScoresAsync(string leaderBoardId, GamesLeaderBoardTimeSpan timeSpan, GamesLeaderboardCollection collection, int maxResults);
        ...
        /// </param>
        /// <returns>A Task that returns a <see cref="IReadOnlyList{T}"/> of <see cref="GamesLeaderboardScore"/></returns>
        Task<IReadOnlyList<GamesLeaderboardScore>> GetTopScoresAsync(string leaderBoardId, GamesLeaderBoardTimeSpan timeSpan, GamesLeaderboardCollection collection, int maxResults);
        ...
        Task<GamesScoreSubmission> SubmitScoreAsync(string leaderBoardId, long score, GamesScoreMetadata metaData = null);
...
#if IOS || MACCATALYST
        /// <summary>
        /// (Apple Only) Raised when the underlying platform reports a capability is unavailable.
        /// Not all platforms provide this information.
        /// </summary>
        event EventHandler<GamesCapability> OnCapabilityUnavailable;
        ...
        /// </summary>
        /// <returns>
        /// A Task that completes with an <see cref="GamesAuthResponse"/> containing <see cref="GamesAuthResponseApple"/>
        /// </returns>
        Task<GamesAuthResponse> RequestServerSideAccessAsync();
#elif ANDROID
        /// <summary>
        /// Requests backend server sign in access to the games SDK for the current platform automatically in the background at app start.
        /// </summary>
        ...
        /// <returns>
        /// A Task that completes with an <see cref="GamesAuthResponse"/> containing <see cref="GamesAuthResponseAndroid"/> and 
        /// the OAuth 2.0 authorization code as a string and a list of the AuthScopes that were effectively granted by the user 
        /// (see description for details on consent). This authorization code can be exchanged by your server for an access token 
        /// (and conditionally a refresh token) that can be used to access the Play Games Services web APIs and other Google Identity 
        /// APIs.
        /// </returns>
        Task<GamesAuthResponse> RequestServerSideAccessAsync(string serverClientId, List<GamesAuthScope> authScopes);        
#endif
        #endregion
    }
}
